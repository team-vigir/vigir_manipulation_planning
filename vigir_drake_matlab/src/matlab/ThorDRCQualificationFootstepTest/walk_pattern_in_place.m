function [ num_steps, waypoint_times_step, waypoints_step, target_link_name_step, t ] = walk_pattern_in_place(world_mat)
...
waypoints_step{current_step} = waypoint;
waypoint.position = setRelativeTargetPosition(0, 0, 0.2, world_mat);
waypoints_step{current_step} = [waypoints_step{current_step} waypoint];
